function[xt_robo,yt_robo, xt_dot, yt_dot, xo, x1, x2, x3, x4, x5, xf, yo,  ko, k1, k2, k3, k4, kf] = getBernstein_no_mid(xo,yo,xf,yf,t0,tf)    
%initialization 
% 
...
to=t0;      %% initial time
% tf=tf;  %% final time
xc1=((xf+xo)/2) ; %% mid point of x-co-ordinate of the robo
yc1=((yf+yo)/2); %;% mid point of y-co-ordinate of the robo
